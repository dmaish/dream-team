...
def add_department():
    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            # in case the department's name already exists
            flash('error:this department already exists.')
...
def delete_department(id):
    ...
    # redirecct to the departments page to view the changes made
    return redirect(url_for('admin.list_departments'))
...
def assign_employee(id):
    """ assigning a department and a role to an employee """
    ...
    # prepopulating the EmployeeAssignmenForm
