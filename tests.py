...
class TestBase(TestCase):
    ...
    def create_app(self):
        # pass in the test configurations
        config_name = 'testing'
        app = create_app(config_name)
        # updating the config dict with the dict.update method
        app.config.update(
...
class TestModels(TestBase):
    ...
    def test_role_model(self):
        ...
        """
        # create test role
        role = Role(name='CE0', description='Run whole company')
...
class TestViews(TestBase):
    ...
    def test_dashboard_view(self):
        """ test that dashboard is inaccessible without login and redirects
